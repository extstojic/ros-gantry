...
GantryDriver::GantryDriver(GantryController* controller) {
    ...
    srv_stop_robot_right_now = nh.advertiseService("/stop_robot_right_now", &GantryDriver::cb_stop, this);    srv_get_fk = private_nh.advertiseService("get_fk", &GantryDriver::cb_get_fk, this);  // Forward kinematics for UI markers
